...
void ui_MiningScreen_screen_init(void)
{
    ...
    lv_obj_set_width(ui_lbHashrate, LV_SIZE_CONTENT); 
    lv_obj_set_height(ui_lbHashrate, LV_SIZE_CONTENT);    
    ...
    lv_obj_set_width(ui_lbTime1, LV_SIZE_CONTENT);
