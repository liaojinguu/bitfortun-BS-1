#include "board.h"
#include "bitfortunoctaxeplus.h"

static const char* TAG="bitfortunoctaxe+";

BitfortunOctaxePlus::BitfortunOctaxePlus() : BitfortunQaxePlus() {
    m_deviceModel = "BitfortunOCTAXE+";
    ...
    m_theme = new ThemeBitfortunoctaxeplus();
#endif
