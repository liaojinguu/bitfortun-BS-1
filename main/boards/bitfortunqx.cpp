#include "board.h"
#include "bitfortunqx.h"
#include "bitfortunqaxeplus2.h"

static const char* TAG="BitfortunQX";
...
BitfortunQX::BitfortunQX() : BitfortunQaxePlus2() {
    m_deviceModel = "BitfortunQX";
...
void BitfortunQX::requestChipTemps() {
