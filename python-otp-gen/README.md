...
Non-interactive (no prompts):
    ...
    python generate_totp_qr.py --issuer "BitfortunQAxe" --account "bitfortunqaxeplus2-B43A"
...
=== otpauth:// URI ===
otpauth://totp/BitfortunQAxe:bitfortunqaxeplus2-B43A?secret=Z24R33BWOPGD6JQOJP7B5F2NWEEKRDFA&issuer=BitfortunQAxe
...
-------------------------------------------------------
    ...
    ./generate_totp_qr.py --issuer "BitfortunQX" --account "bitfortunqaxeplus2-B43A"
